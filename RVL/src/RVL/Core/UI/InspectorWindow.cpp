...
namespace Rvl
{
    ...
    InspectorWindow::InspectorWindow(const std::string& name) : _name(name) {}
    ...
    void InspectorWindow::SetName(const std::string& name)
    {
        _name = name;
    }

    std::string InspectorWindow::GetName() const
    {
        return _name;
    }
}
